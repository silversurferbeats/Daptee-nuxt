            ...
            <div
                ...
                <div class="w-[80%] flex min-h-screen items-center justify-center">
                    <div
                        ...
                        <figure
                            class="mx-auto mb-4 flex h-32 w-32 items-center justify-center rounded-full bg-indigo-500 dark:bg-indigo-600">
                            <img class="rounded-full" :src="user.avatar" alt="imgAvatar">
                        </figure>
                        <h2 class="mt-4 text-4xl font-bold text-indigo-600 dark:text-indigo-400">{{ user.name || "Usuario" }}</h2>
